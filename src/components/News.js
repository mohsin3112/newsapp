...
const News = (props) => {
  ...
  // for capaitalize first letter of document Title
  ...
  const fetchData = async () => {
    ...
    //.concat is used to join old data to new data used during infinite scrolling.
    setArticles(articles.concat(parseData.articles));
    // totalresult gives the total number of fetched data
